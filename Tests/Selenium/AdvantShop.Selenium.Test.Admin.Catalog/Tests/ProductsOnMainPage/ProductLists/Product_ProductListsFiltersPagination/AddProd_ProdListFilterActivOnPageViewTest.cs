...
{
    [TestFixture]
    public class Prod_ProdListAddFilterActivOnPageViewTest : BaseSeleniumTest
    {
        [OneTimeSetUp]
        ...
        [Test]
        public void AddProduct_ProductListsFilterActivityOnPage()
        {
            testname = "AddProduct_ProductListsFilterActivityOnPage";
        ...
        [Test]
        public void AddProduct_ProductListsFilterActivityOnPageToPrev()
        {
            testname = "AddProduct_ProductListsFilterActivityOnPageToPrev";
            VerifyBegin(testname);
        ...
        [Test]
        public void AddProduct_ProductListsFilterActivityOnView()
        {
            testname = "AddProduct_ProductListsFilterActivityOnView";
            VerifyBegin(testname);
