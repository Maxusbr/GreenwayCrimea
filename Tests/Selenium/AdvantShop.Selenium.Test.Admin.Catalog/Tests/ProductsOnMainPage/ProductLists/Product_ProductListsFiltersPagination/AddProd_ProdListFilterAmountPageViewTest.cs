...
{
    [TestFixture]
    public class Prod_ProdListAddFilterAmountPageViewTest : BaseSeleniumTest
    {
        [OneTimeSetUp]
     ...
     "data\\Admin\\Catalog\\ProductsOnMainPage\\ProductLists\\AddProd_ProdLists\\FilterPage\\Catalog.Product.csv",
        ...
        [Test]
        public void AddProduct_ProductListsFilterAmountPage()
        {
            testname = "AddProduct_ProductListsFilterAmountPage";
        ...
        [Test]
        public void AddProduct_ProductListsFilterAmountPageToPrev()
        {
            testname = "AddProduct_ProductListsFilterAmountPageToPrev";
            VerifyBegin(testname);
        ...
        [Test]
        public void AddProduct_ProductListsFilterAmountView()
        {
            testname = "AddProduct_ProductListsFilterAmountView";
            VerifyBegin(testname);
