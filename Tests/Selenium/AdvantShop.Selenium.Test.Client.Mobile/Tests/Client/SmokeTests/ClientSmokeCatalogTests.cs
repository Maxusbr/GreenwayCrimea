...
namespace AdvantShop.SeleniumTest.Client
{
    ...
    public class ClientSmokeCatalogTests : BaseSeleniumTest
    {
        ...
        public void ClientCategoryOpen()
        {
            ...
            Assert.IsTrue(driver.FindElement(By.CssSelector("[data-product-id=\"1\"]")).FindElement(By.CssSelector(".products-view-price")).Text.Contains("0,50"));
            Assert.IsTrue(driver.FindElement(By.CssSelector("[data-product-id=\"1\"]")).FindElement(By.CssSelector(".color-viewer-item.color-viewer-item-selected.cs-br-2.js-carousel-item")).Displayed);
        ...
        public void ClientCategoryView()
        {
            ...
            Assert.IsFalse(driver.FindElements(By.CssSelector(".row.products-view.products-view-list")).Count > 0);
            Assert.IsFalse(driver.FindElements(By.CssSelector(".row.products-view.products-view-table")).Count > 0);
            ...
            Assert.IsFalse(driver.FindElements(By.CssSelector(".row.products-view.products-view-tile")).Count > 0);
            Assert.IsFalse(driver.FindElements(By.CssSelector(".row.products-view.products-view-table")).Count > 0);
        ...
        public void ClientProductOpen()
        {
            ...
            Assert.IsTrue(driver.FindElements(By.CssSelector(".details-row.details-weight"))[0].FindElement(By.CssSelector(".details-param-value")).Text.Contains("1"));
            Assert.IsTrue(driver.FindElements(By.CssSelector(".details-row.details-weight"))[0].FindElement(By.CssSelector(".details-param-name")).Text.Contains("Вес:"));
            Assert.IsTrue(driver.FindElements(By.CssSelector(".details-row.details-weight"))[1].FindElement(By.CssSelector(".details-param-value")).Text.Contains("unit"));
            Assert.IsTrue(driver.FindElements(By.CssSelector(".details-row.details-weight"))[1].FindElement(By.CssSelector(".details-param-name")).Text.Contains("Ед. измерения:"));
            ...
            //check cart
            Assert.IsTrue(driver.FindElement(By.CssSelector(".details-row.details-payment.cs-br-1")).Text.Contains("0,50"));
        ...
        public void ClientProductColorAmount()
        {
            ...
            Assert.IsTrue(driver.FindElement(By.CssSelector("[title=\"Color1\"]")).GetAttribute("class").Contains("color-viewer-item"));
            Assert.IsTrue(driver.FindElement(By.CssSelector("[title=\"Color4\"]")).GetAttribute("class").Contains("color-viewer-item color-viewer-item-selected cs-br-2"));
            ...
            Thread.Sleep(1000);
            Assert.IsTrue(driver.FindElement(By.CssSelector("[title=\"Color4\"]")).GetAttribute("class").Contains("color-viewer-item"));
            Assert.IsTrue(driver.FindElement(By.CssSelector("[title=\"Color1\"]")).GetAttribute("class").Contains("color-viewer-item color-viewer-item-selected cs-br-2"));
        ...
        public void ClientCategoryFilterBrand()
        {
            ...
            Thread.Sleep(1000);
            Assert.IsTrue(driver.FindElement(By.CssSelector("[data-ng-bind='catalogFilter.foundCount']")).Text.Contains("1"));
            driver.FindElement(By.CssSelector("[data-ng-click='catalogFilter.submit()']")).Click();
