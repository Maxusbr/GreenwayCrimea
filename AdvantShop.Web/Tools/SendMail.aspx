<%@ Page Language="C#" AutoEventWireup="true" Inherits="Tools.SendMail" Codebehind="SendMail.aspx.cs" %>
...
<head runat="server">
    ...
    <style type="text/css" >
        ...
        .clsTextBase {width: 175px;}
        .clsText {border:1px solid #DDDDDD; padding:6px; font-size:14px;}
        .clsText_faild {border:1px solid #E5A3A3; padding:6px; font-size:14px; background-color: #FFCFCF;}
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="ContentDiv">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPort" runat="server" CssClass="clsTextBase clsText" Text="25"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFrom" runat="server" CssClass="clsTextBase clsText" Width="258px" ></asp:TextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTo" runat="server" CssClass="clsTextBase clsText" Width="258px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <br />
            <asp:Button ID="btnSendMail" runat="server" Text="SendMail" CssClass="btn btn-m" Width="105px" OnClick="btnSendMail_Click" />
            <br />
            <br />
