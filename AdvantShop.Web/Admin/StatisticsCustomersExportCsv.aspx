<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" Inherits="Admin.StatisticsCustomersExportCsv" CodeBehind="StatisticsCustomersExportCsv.aspx.cs" %>
            ...
            <div>
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblHead" CssClass="AdminHead" runat="server" Text="<%$ Resources:Resource,Admin_Statistics_ExportCustomersHeader %>"></asp:Label><br />
                            <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="Выгрузка данных по покупателям в csv"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
            <div>
                <div id="divAction" runat="server">
                    <table class="export-settings">
                        <tr>
                            <td>
                                <span>Группа покупателей:</span>
                            </td>
                            <td>
                                <asp:DropDownList runat="server" ID="ddlGroup" Style="display: inline-block" Width="150px" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="dp" style="width: 150px; float: left;">от
                                ...
                                <div class="dp" style="width: 150px; float: left;">до
                        ...
                        <tr>
                            <td>
                                <span>Разделитель между адресами:</span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtAddressSeparator" runat="server" MaxLength="5" Text=";" Width="150px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <div style="text-align: center;">
                            ...
                            <a id="hlStart" style="display: none" class='Link' href="StatisticsCustomersExportCsv.aspx">
