<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" Inherits="Admin.PropertyValues" Codebehind="PropertyValues.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <div id="inprogress" style="display: none;">
       ...
       <div class="content-top">
        <menu class="neighbor-menu neighbor-catalog">
            ...
            <li class="neighbor-menu-item selected"><a href="Properties.aspx">
    ...
    <div class="content-own">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="lnkBack" runat="server" Text="<%$ Resources:Resource, Admin_PropertiesValues_Back %>"></asp:HyperLink>
        ...
        <div style="width: 100%">
            <div>
                <div class="btns-main">
                    <asp:Button CssClass="btn btn-middle btn-add" ID="btnAddProperty" runat="server" Text="<%$ Resources:Resource, Admin_PropertiesValues_AddValue %>" ValidationGroup="0" OnClick="btnAddProperty_Click" />
                </div>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Value" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtValueBind" runat="server" Text='<%# Eval("Value") %>' Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="SortOrder" ItemStyle-Width="200" HeaderStyle-Width="200">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="txtSortOrderBind" Width="99%" Text='<%# Bind("SortOrder") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="50px" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <EditItemTemplate>
                                            <asp:LinkButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip valid-confirm" CommandName="DeletePropertyValue" CommandArgument='<%# Eval("ID")%>'
