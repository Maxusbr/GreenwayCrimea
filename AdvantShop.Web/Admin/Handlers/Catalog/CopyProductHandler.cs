...
namespace AdvantShop.Admin.Handlers.Catalog
{
    public class CopyProductHandler
    {
        public int Exectute(Product sourceProduct, string name, string artno, string url)
        {
            var meta = sourceProduct.Meta;
            meta.ObjId = 0;
