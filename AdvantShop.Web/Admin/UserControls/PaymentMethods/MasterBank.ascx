<%@ Control Language="C#" AutoEventWireup="true" Inherits="Admin.UserControls.PaymentMethods.MasterBankControl" Codebehind="MasterBank.ascx.cs" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
     ...
     <tr>
        <td class="columnName">
            <asp:Localize ID="Localize1" runat="server" Text="Секретное слово"></asp:Localize><span class="required">&nbsp;*</span>
        </td>
        <td class="columnVal">
        ...
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
                ToolTip="<%$ Resources:Resource, Admin_PaymentMethod_WebMoney_Purse_Description %>" /><asp:Label
                    runat="server" ID="msgSecretWord" Visible="false" ForeColor="Red"></asp:Label>
        </td>
    </tr>
</table>
