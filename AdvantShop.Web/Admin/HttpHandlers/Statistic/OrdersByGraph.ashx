<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Statistic.OrdersByGraph" %>
...
{
    public class OrdersByGraph : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            var handler = new OrdersByHandler(datefrom, dateto, statusId, paied, groupFormatString);
            switch (type)
            {
                case "payment":
