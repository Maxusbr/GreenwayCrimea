<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Order.SdekReportOrderStatus" %>
...
{
    public class SdekReportOrderStatus : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            SdekStatusAnswer result = (new Sdek(shippingMethod, null)).ReportOrderStatuses(order);
