<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Order.SdekCallCustomer" %>
...
{
    public class SdekCallCustomer : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            SdekStatusAnswer result = (new Sdek(shippingMethod, null)).CallCustomer(order);
