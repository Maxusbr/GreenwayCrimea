...
namespace Admin
{
    public partial class Departments : AdvantShopAdminPage
    {
        #region private
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    TableName = "[Customers].[Departments]",
                    ItemsPerPage = 20,
                    CurrentPageIndex = 1
                };
                ...
                _paging.AddFieldsRange(new[]
                    {
                        new Field {Name = "DepartmentId as ID", IsDistinct = true},
                        new Field {Name = "Name"},
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            //----SortOrder filter
            _paging.Fields["Sort"].Filter = string.IsNullOrEmpty(txtSortOrder.Text)
                                                     ? null
                                                     : new CompareFieldFilter
                                                     {
                                                         ParamName = "@Sort",
        ...
        protected void lbDeleteSelected_Click(object sender, EventArgs e)
        {
            if ((_selectionFilter != null) && (_selectionFilter.Values != null))
            {
                if (!_inverseSelection)
                {
                    ...
                    {
                        DepartmentService.DeleteDepartments(SQLDataHelper.GetInt(id));
                    }
                }
                else
                {
                    var itemsIds = _paging.ItemsIds<int>("DepartmentId as ID");
        ...
        protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                DepartmentService.DeleteDepartments(SQLDataHelper.GetInt(e.CommandArgument));
            }
            ...
            if (e.CommandName == "AddDepartment")
            {
                try
                {
                    ...
                    if (DepartmentService.AddDepartments(new Department
                    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            {
                DepartmentService.UpdateDepartments(new Department
                {
                    DepartmentId = SQLDataHelper.GetInt(grid.UpdatedRow["ID"]),
                    Name = grid.UpdatedRow["Name"],
                    Sort = grid.UpdatedRow["Sort"].TryParseInt(),
