<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" Inherits="Admin.SiteMapGenerateXML" Codebehind="SiteMapGenerateXML.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="content-own">
        <div style="text-align: center;">
            <asp:Label ID="lblHead" CssClass="AdminHead" runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerateXML_Header %>" /><br />
            <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerateXML_SubHeader %>" />
        </div>
        ...
        <table class="table-ui">
            <tr>
                <td class="table-ui-align-right table-ui-font-bold" style="width: 50%;">
                    <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerateXML_LastGenerationDate %>" />
                </td>
                <td>
            ...
            <tr>
                <td class="table-ui-align-right table-ui-font-bold">
                    <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerateXML_LinkSiteMap %>" />
                </td>
                <td>
                    <%= SettingsMain.SiteUrl + LinkToSiteMapFile %>
                    ( <a href="<%= LinkToSiteMapFile + ("?" + new Random().Next()) %>" target="_blank">
                          <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerateXML_LinkSiteMapGo %>" />
                      </a> )
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <a href="CommonSettings.aspx#tabid=task">
                        <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_SiteMapGenerate_Set %>" />
                    </a> 
                </td>
            </tr>
        </table>
        <div style="text-align: center; margin-top: 20px;">
            <asp:Button ID="btnCreateMap" runat="server" CssClass="btn btn-middle btn-add"  OnClick="btnCreateMap_Click"
                Text="<%$ Resources:Resource,Admin_SiteMapGenerateXML_Generate %>" />
        </div>
    </div>
</asp:Content>
