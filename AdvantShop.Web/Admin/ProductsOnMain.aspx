<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CatalogLayout.master" AutoEventWireup="true" Inherits="Admin.ProductsOnMain" ValidateRequest="false" Codebehind="ProductsOnMain.aspx.cs" %>
                ...
                <table class="filter" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 250px;">
                            <div style="width: 10%; font-size: 0px; height: 0px;">
                            </div>
                            <asp:TextBox CssClass="filtertxtbox" ID="txtArtNo" Width="99%" runat="server" TabIndex="11" />
                        </td>
                        <td>
                            <div style="width: 80%; font-size: 0px; height: 0px;">
                            </div>
