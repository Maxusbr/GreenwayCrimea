<%@ Control Language="C#" AutoEventWireup="true"
            Inherits="AdvantShop.Module.GoogleImagesSearch.Admin_GoogleImagesSearchModule" Codebehind="GoogleImagesSearchModule.ascx.cs" %>
<div style="text-align: center;">
    <table border="0" cellpadding="2" cellspacing="0">
        ...
        <tr class="rowsPost">
            <td>
                <asp:Localize runat="server" Text="<%$ Resources: CSEngineId %>" />
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtCSEngineId" Width="300px" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
