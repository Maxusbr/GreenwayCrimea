; (function (ng) {
    ...
    var ModalSearchImagesCtrl = function ($uibModalInstance, $http, toaster, $q) {
        ...
        ctrl.fetch = function () {
            $http.get('../googleImagesSearch/searchImagesById', { params: ng.extend(ctrl.uploadbylinkParams, { page: ctrl.page }) }).then(function (response) {
