...
{
    public partial class AbandonedCartsModuleWishListUnReg : UserControl
    {
        ...
        protected void btnSendLetter_OnClick(object sender, EventArgs e)
        {
            ...
            int count = AbandonedCartsService.SendMessageUnReg(template, cartIds, ShoppingCartType.Wishlist);
