<%@ Control Language="C#" AutoEventWireup="true" Inherits="AdvantShop.Module.AbandonedCarts.AbandonedCartsModuleUnReg" Codebehind="AbandonedCartsModuleUnReg.ascx.cs" %>
...
<div>
    <div style="font-size: 16px; margin: 10px 0;">
        <asp:Localize runat="server" Text="<%$ Resources: CartsUnRegUsers%>"/>
    </div>
            ...
            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                        <EditItemTemplate>
                            <%# "<a href=\"../Modules/AbandonedCarts/CartInfo.aspx?Id=" + Eval("CustomerId") + "&MasterPageEmpty=" + Request["MasterPageEmpty"] + "&ShoppingCartType=1" +  "\" class='showtooltip' title=\"Редактировать\"><img src='images/editbtn.gif' style='border: none;'  /></a>" %>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <%# "<a href=\"../Modules/AbandonedCarts/CartInfo.aspx?Id=" + Eval("CustomerId")  + "&MasterPageEmpty=" + Request["MasterPageEmpty"] + "&ShoppingCartType=1" + "\" class='showtooltip' title=\"Редактировать\"><img src='images/editbtn.gif' style='border: none;'  /></a>" %>
                        </ItemTemplate>
        ...
        <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>--%>
                ...
                <div style="padding: 5px 0 15px 0">
                    <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources: ChooseTemplate %>" />
