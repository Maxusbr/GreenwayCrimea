<%@ Control Language="C#" AutoEventWireup="true" Inherits="AdvantShop.Module.AbandonedCarts.AbandonedCartsModule" CodeBehind="AbandonedCartsModule.ascx.cs" %>
            ...
            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <%# "<a href=\"../Modules/AbandonedCarts/CartInfo.aspx?Id=" + Eval("CustomerId") + "&MasterPageEmpty=" + Request["MasterPageEmpty"] + "&ShoppingCartType=1" + "\" class='showtooltip'><img src='images/editbtn.gif' style='border: none;'  /></a>" %>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
